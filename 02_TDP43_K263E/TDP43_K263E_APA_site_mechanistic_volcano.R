...
TABLE_OUT <- file.path(
  OUT_DIR,
  "TDP43_K263E_APA_site_mechanistic_results.tsv"
)

PDF_OUT <- file.path(
  OUT_DIR,
  "TDP43_K263E_APA_site_mechanistic_volcano.pdf"
)

PNG_OUT <- file.path(
  OUT_DIR,
  "TDP43_K263E_APA_site_mechanistic_volcano.png"
)
...
#
# positive:
# increased usage in K263E
#
# negative:
# decreased usage in K263E
# ============================================================
...
p <- ggplot(
  ...
  labs(
    ...
    title =
      "TDP-43 K263E alters alternative polyadenylation",
