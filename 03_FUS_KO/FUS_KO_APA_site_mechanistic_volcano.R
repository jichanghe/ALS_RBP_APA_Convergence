...
TABLE_OUT <- file.path(
  OUT_DIR,
  "FUS_KO_APA_site_mechanistic_results.tsv"
)

PDF_OUT <- file.path(
  OUT_DIR,
  "FUS_KO_APA_site_mechanistic_volcano.pdf"
)

PNG_OUT <- file.path(
  OUT_DIR,
  "FUS_KO_APA_site_mechanistic_volcano.png"
)
...
# ============================================================
# 5B. Validate FUS KO sample columns
# ============================================================
...
if (length(missing_cols) > 0) {
  ...
  cat(
    "\nERROR: Missing expected FUS KO QAPA columns:\n"
  )
  ...
  stop(
    "Sample columns do not match FUS_KO_GSE71812."
  )
}
...
# 7. Expression filter
#
# TPM >= 1 in at least 2/12 samples
# ============================================================
...
#
# positive:
# increased usage in FUS KO
#
# negative:
# decreased usage in FUS KO
# ============================================================
...
p <- ggplot(
  ...
  labs(
    ...
    title =
      "FUS KO alters alternative polyadenylation",
