# ============================================================
# TDP-43 KO QAPA differential APA analysis
#
# Input:
# TDP43_KO_QAPA_PAU.tsv
#
# Outputs:
# TDP43_KO_differential_APA.xlsx
# TDP43_KO_volcano.pdf
# TDP43_KO_PCA.pdf
# TDP43_KO_heatmap.pdf
# TDP43_KO_shortening_lengthening.pdf
#
# Comparison:
...
p_volcano <- ggplot(
  ...
  labs(
    title = "TDP-43 KO differential alternative polyadenylation",
    subtitle = paste0(
      "FDR < ",
      FDR_CUTOFF,
      " and |DeltaPAU| >= ",
...
pca_plot_df$Group <- ifelse(
  grepl("^Cont_", pca_plot_df$Sample),
  "Control",
  "TDP-43 KO"
)
...
length_list <- lapply(
  ...
  function(g) {
    ...
    data.frame(
      ...
      Cont_S1 = calc_weighted_length(g, "Cont_S1.PAU"),
      Cont_S2 = calc_weighted_length(g, "Cont_S2.PAU"),
      Cont_S3 = calc_weighted_length(g, "Cont_S3.PAU"),
      Cont_S4 = calc_weighted_length(g, "Cont_S4.PAU"),

      TDP43_S5 = calc_weighted_length(g, "TDP43_S5.PAU"),
      TDP43_S6 = calc_weighted_length(g, "TDP43_S6.PAU"),
      TDP43_S7 = calc_weighted_length(g, "TDP43_S7.PAU"),
...
length_df$Control_mean_length <- rowMeans(
  length_df[, c(
    "Cont_S1",
    "Cont_S2",
    "Cont_S3",
...
length_df$KO_mean_length <- rowMeans(
  length_df[, c(
    "TDP43_S5",
    "TDP43_S6",
    "TDP43_S7"
...
length_df$Delta_UTR_length <- (
  length_df$KO_mean_length -
  length_df$Control_mean_length
)
...
p_sl <- ggplot(
  ...
  labs(
    title = "TDP-43 KO alters 3'UTR length",
    subtitle = paste0(
