...
OUT_DIR <- "results/05_MATR3_KO"

INPUT <- file.path(
  OUT_DIR,
  "MATR3_KO_QAPA_PAU.tsv"
)

TABLE_OUT <- file.path(
  OUT_DIR,
  "MATR3_KO_APA_site_mechanistic_results.tsv"
)

PDF_OUT <- file.path(
  OUT_DIR,
  "MATR3_KO_APA_site_mechanistic_volcano.pdf"
)

PNG_OUT <- file.path(
  OUT_DIR,
  "MATR3_KO_APA_site_mechanistic_volcano.png"
)
...
dat$MATR3_KO_mean_PAU <- rowMeans(
...
#
# positive:
# increased usage in MATR3 KO
#
# negative:
# decreased usage in MATR3 KO
# ============================================================

dat$DeltaPAU <- (
  dat$MATR3_KO_mean_PAU -
  dat$WT_mean_PAU
)
...
p <- ggplot(
  ...
  labs(
    ...
    title =
      "MATR3 KO alters alternative polyadenylation",
